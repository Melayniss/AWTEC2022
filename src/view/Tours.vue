...
.box-item-wrapper:hover .box-item-top > i {
  opacity: 0;
}

.box-item-wrapper:hover .box-item-top > p {
  opacity: 1;
  transform: translateY(-10px);
}

.box-item-wrapper:hover .box-item-img > img {
  transform: scale(1.1, 1.1);
}

.box-item-wrapper:hover > .box-item-border {
  opacity: 1;
  width: 90%;
  height: 90%;
}
