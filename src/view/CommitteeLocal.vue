<template>
  <div id="local">
    <div>
      <p class="local-title text-center">{{ title }}</p>
      ...
      >
        <ul>
          <li>
            <div class="local-photograph">
              <img class="center-block" :src="item.photograph" alt="Committees Partner">
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      committeeList: [
        {
          photograph: require("@/assets/img/prof/local_0.jpg"),
          title:
        ...
        {
          photograph: require("@/assets/img/prof/local_1.jpg"),
          title:
        ...
        {
          photograph: require("@/assets/img/prof/local_2.jpg"),
          title:
        ...
        {
          photograph: require("@/assets/img/prof/local_3.jpg"),
          title:
        ...
        {
          photograph: require("@/assets/img/prof/local_4.jpg"),
          title:
        ...
        {
          photograph: require("@/assets/img/prof/local_5.jpg"),
          title:
...
#local .local-name {
  ...
  font-weight: bold;
  font-style: italic;
  border-bottom: 1px solid #134857;
}
